...
export function downloadSitesTemplate(): void {
  const headers = 'projectCode,siteCode,siteName,city,state,circle,division,address,latitude,longitude,sapCode,zone,voltageClass,totalBays,numPowerTransformers';
  const sample1 = 'IOT,SUB-PUNE-047,Pune Substation 47,Pune,Maharashtra,,,,18.5204,73.8567,SAP-00123,Pune Zone,132,12,2';
