  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        'max-sm:inset-0 max-sm:translate-x-0 max-sm:translate-y-0 max-sm:left-0 max-sm:top-0 max-sm:max-w-full max-sm:rounded-none max-sm:h-full max-sm:overflow-y-auto',
        className
      )}
      {...props}
    >
