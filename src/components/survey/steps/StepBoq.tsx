...
/** Bill of Quantity — Section J. Fields added in task 3. */
export function StepBoq({ readOnly }: SurveyStepProps) {
  return (
    <div className="flex flex-col gap-2">
      <h3 className="text-base font-semibold text-gray-900">Bill of Quantity</h3>
      <p className="text-sm text-gray-400">Section J — fields added in task 3.</p>
      {readOnly && (
